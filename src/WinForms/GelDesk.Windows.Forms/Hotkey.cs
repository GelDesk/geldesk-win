...
{
    /// <summary>
    /// Manages a global hot key in Windows.
    /// </summary>
    /// <remarks>
    /// Public Domain code: "I hope someone finds this useful and to 
    /// facilitate that process I hereby place all the code into the public 
    /// domain to be messed around with to your hearts content. Enjoy!" - 
    /// https://bloggablea.wordpress.com/2007/05/01/global-hotkeys-with-net/
    /// 
    /// "If you are wondering about the requirement for a form parameter to 
    /// Register and GetCanRegister, this is simply a requirement of the 
    /// underlying APIs, probably due to the fact that they signal hotkey 
    /// presses in the application message loop rather than via a callback." - 
    /// https://bloggablea.wordpress.com/2007/05/01/global-hotkeys-with-net/
    /// 
    /// </remarks>
    /// <example>
    /// // You can setup a hotkey like this:
	...
	public class Hotkey : IMessageFilter
	{
		...
		public static Hotkey CreateAndRegister(Control windowControl, Action<Hotkey> setup, HandledEventHandler onPressed)
		{
			var hk = new Hotkey();

			setup(hk);

			if (hk.Register(windowControl))
			{
